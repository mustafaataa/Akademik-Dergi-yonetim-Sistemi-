...
$a="SELECT * FROM makaleler WHERE  durumid=4 ";
$b=mysqli_query($baglanti,$a);


$bes="SELECT * FROM makaleler WHERE  durumid!=4 ";
...
while ($yaz1=mysqli_fetch_array($b,MYSQLI_ASSOC)  ) {
   ...
   echo "<td><a href=https://localhost/IBRAHIM/makale/$yaz1[dosyaadi]>$yaz1[dosyaadi]</a></td>";
   echo "</tr>";
   }
