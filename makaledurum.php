...
<center><h3 style="color: blue;" >ONAYLANAN MAKALE LİSTESİ</h3></center><div class="a" style=" padding-top: 10px;">
...
while ($yaz1=mysqli_fetch_array($b,MYSQLI_ASSOC)  ) {
   ...
   echo "<td><a href=https://localhost/ibrahim/makale/$yaz1[makale_adi]>$yaz1[makale_adi]</a></td>";
   echo "</tr>";
	}
